...
Type BoxedStrArray Extends BoxedArray
	Public:
		...
		Declare Function RemoveBoxedStr(idx As Long) As BoxedString Ptr
		Declare Sub DeleteBoxedStr(idx As Long)
...
Sub BoxedStrArray.SetMovedBoxedStr(idx As Long, o As BoxedString Ptr)
	...
	SetItem(idx, o)
End Sub
Function BoxedStrArray.RemoveBoxedStr(idx As Long) As BoxedString Ptr
	Dim o0 As BoxedString Ptr = Cast(BoxedString Ptr, GetItem(idx))
	SetItem(idx, NULL)
	Return o0
End Function
Sub BoxedStrArray.DeleteBoxedStr(idx As Long)
	Dim o As BoxedString Ptr = RemoveBoxedStr(idx)
	Delete o
End Sub
...
Function BoxedStrArray.GetStr(idx As Long) As String
	Dim p As BoxedString Ptr : p = Cast(BoxedString Ptr, GetItem(idx))
	If p <> NULL Then
		Return p->Value()
	Else
		Return ""
